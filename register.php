...
<body>
<div id="container">
	<div id="baner"><img src="logo.png"></div>
	<div id="content">
		<fieldset>
...
if ($_POST) {
    ...
    //Wysylanie maila
    $message = "Witaj. Aby móc zalogować się na stronie kliknij poniższy link.";
    ...
    if (!empty($errors)) {
        ...
        // Zapisz dane do bazy
        $result = $db->query("INSERT INTO users (imie, nazwisko, login, email, password, admin, aktywacja) VALUES('$imie', '$nazwisko', '$login', '$email', '$password', '$admin', '$kod')");
